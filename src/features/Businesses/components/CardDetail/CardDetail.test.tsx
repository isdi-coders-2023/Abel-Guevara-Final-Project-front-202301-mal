...
describe('Given a CardDetail component', () => {
  ...
  describe('When the state of Delete is sucess', () => {
    test('Then it should changes return to idle', async () => {
      renderWithProviders(
        <MemoryRouter initialEntries={['/delete']}>
          <Routes>
            <Route
              ...
              element={<CardDetail businessId="2023" />}
            ></Route>
            <Route path="/" element={<h1>Redirect OK</h1>}></Route>
          </Routes>
        </MemoryRouter>,
        {
          preloadedState: {
